...
from collective.volto.subsites.testing import COLLECTIVE_VOLTO_SUBSITES_INTEGRATION_TESTING  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    layer = COLLECTIVE_VOLTO_SUBSITES_INTEGRATION_TESTING
